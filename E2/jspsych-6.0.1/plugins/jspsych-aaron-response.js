...
jsPsych.plugins["aaron-response"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // Stimuli.
    var label_left = '<img src="'+trial.label_left+'" id="stimuli"></img>';
    var label_right = '<img src="'+trial.label_right+'" id="stimuli"></img>';
    var target_item = '<img src="'+trial.target_item+'" id="item"></img>';

    // Main space sections.
    var left_label_div = '<div class="left_label_div">' + label_left + '</div>';
    var right_label_div = '<div class="right_label_div">' + label_right +'</div>';
    var item_div = '<div class="item_div">' + target_item +'</div>';

    if (trial.prompt !== null){
      label_left += trial.prompt;
      label_right += trial.prompt;
      target_item += trial.prompt;
    }

    // Draw.
    display_element.innerHTML = left_label_div + right_label_div + item_div
    // display_element.innerHTML = label_left + label_right + target_item + item_div + left_label_div + right_label_div;
...
//////////////////////////////
    ...
    stimuli = display_element.querySelector('#item');
    displayBox = display_element.querySelector('.item_div');
    stimuli.onmousedown = function(event) {
      let shiftX = event.clientX - stimuli.getBoundingClientRect().left;
      let shiftY = event.clientY - stimuli.getBoundingClientRect().top;
